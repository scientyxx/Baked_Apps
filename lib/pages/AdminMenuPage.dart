    ...
    if (_userRole == null) {
      return Scaffold( // <--- HAPUS 'const' DI SINI
        appBar: AppBar(
          ...
          // actions tidak perlu const karena ada onPressed
        ),
        body: const Center(child: CircularProgressIndicator()), // const di Center boleh karena isinya const
      );
    }

    return Scaffold(
      appBar: AppBar( // <--- PASTIKAN TIDAK ADA 'const' DI SINI (sudah tidak ada di kode sebelumnya)
        title: const Text("Admin/Kasir Menu"),
        centerTitle: true,
        backgroundColor: const Color(0xFFC35A2E),
        foregroundColor: Colors.white,
        actions: [
